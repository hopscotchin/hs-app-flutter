...
/// Promo/coupon code, e.g. "10OFF".
 ...
 bool get copyCoupon;/// `offersList.data[].trackingMeta`, forwarded whole. Analytics never reads a key
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OfferEntity&&(identical(other.couponCode, couponCode) || other.couponCode == couponCode)&&(identical(other.header, header) || other.header == header)&&(identical(other.description, description) || other.description == description)&&(identical(other.displayCoupon, displayCoupon) || other.displayCoupon == displayCoupon)&&(identical(other.copyCoupon, copyCoupon) || other.copyCoupon == copyCoupon)&&const DeepCollectionEquality().equals(other.trackingMeta, trackingMeta));
}


@override
int get hashCode => Object.hash(runtimeType,couponCode,header,description,displayCoupon,copyCoupon,const DeepCollectionEquality().hash(trackingMeta));

@override
String toString() {
  return 'OfferEntity(couponCode: $couponCode, header: $header, description: $description, displayCoupon: $displayCoupon, copyCoupon: $copyCoupon, trackingMeta: $trackingMeta)';
}
...
@useResult
$Res call({
 String? couponCode, String? header, String? description, bool displayCoupon, bool copyCoupon, Map<String, dynamic>? trackingMeta
});
...
/// Create a copy of OfferEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? couponCode = freezed,Object? header = freezed,Object? description = freezed,Object? displayCoupon = null,Object? copyCoupon = null,Object? trackingMeta = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? couponCode,  String? header,  String? description,  bool displayCoupon,  bool copyCoupon,  Map<String, dynamic>? trackingMeta)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OfferEntity() when $default != null:
return $default(_that.couponCode,_that.header,_that.description,_that.displayCoupon,_that.copyCoupon,_that.trackingMeta);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? couponCode,  String? header,  String? description,  bool displayCoupon,  bool copyCoupon,  Map<String, dynamic>? trackingMeta)  $default,) {final _that = this;
switch (_that) {
case _OfferEntity():
return $default(_that.couponCode,_that.header,_that.description,_that.displayCoupon,_that.copyCoupon,_that.trackingMeta);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? couponCode,  String? header,  String? description,  bool displayCoupon,  bool copyCoupon,  Map<String, dynamic>? trackingMeta)?  $default,) {final _that = this;
switch (_that) {
case _OfferEntity() when $default != null:
return $default(_that.couponCode,_that.header,_that.description,_that.displayCoupon,_that.copyCoupon,_that.trackingMeta);case _:
  return null;
...
class _OfferEntity implements OfferEntity {
  const _OfferEntity({this.couponCode, this.header, this.description, this.displayCoupon = true, this.copyCoupon = true, final  Map<String, dynamic>? trackingMeta}): _trackingMeta = trackingMeta;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OfferEntity&&(identical(other.couponCode, couponCode) || other.couponCode == couponCode)&&(identical(other.header, header) || other.header == header)&&(identical(other.description, description) || other.description == description)&&(identical(other.displayCoupon, displayCoupon) || other.displayCoupon == displayCoupon)&&(identical(other.copyCoupon, copyCoupon) || other.copyCoupon == copyCoupon)&&const DeepCollectionEquality().equals(other._trackingMeta, _trackingMeta));
}


@override
int get hashCode => Object.hash(runtimeType,couponCode,header,description,displayCoupon,copyCoupon,const DeepCollectionEquality().hash(_trackingMeta));
...
/// Create a copy of OfferEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? couponCode = freezed,Object? header = freezed,Object? description = freezed,Object? displayCoupon = null,Object? copyCoupon = null,Object? trackingMeta = freezed,}) {
