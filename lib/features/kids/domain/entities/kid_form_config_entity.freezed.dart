...
mixin _$KidFormConfigEntity {
 ...
 String get heading; String get subheading; String get bannerText; Color get bannerBackgroundColor; String get consentText; String get viewPrivacyPolicyLabel; String get viewPrivacyPolicyUrl;// Shown on the screen's own photo-picker circle (the tappable trigger
...
@override
int get hashCode => Object.hash(runtimeType,heading,subheading,bannerText,bannerBackgroundColor,consentText,viewPrivacyPolicyLabel,viewPrivacyPolicyUrl,placeholderImage,const DeepCollectionEquality().hash(avatars));

@override
String toString() {
  return 'KidFormConfigEntity(heading: $heading, subheading: $subheading, bannerText: $bannerText, bannerBackgroundColor: $bannerBackgroundColor, consentText: $consentText, viewPrivacyPolicyLabel: $viewPrivacyPolicyLabel, viewPrivacyPolicyUrl: $viewPrivacyPolicyUrl, placeholderImage: $placeholderImage, avatars: $avatars)';
}
...
@useResult
$Res call({
 String heading, String subheading, String bannerText, Color bannerBackgroundColor, String consentText, String viewPrivacyPolicyLabel, String viewPrivacyPolicyUrl, String? placeholderImage, List<KidAvatarOptionEntity> avatars
});
...
/// Create a copy of KidFormConfigEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? heading = null,Object? subheading = null,Object? bannerText = null,Object? bannerBackgroundColor = null,Object? consentText = null,Object? viewPrivacyPolicyLabel = null,Object? viewPrivacyPolicyUrl = null,Object? placeholderImage = freezed,Object? avatars = null,}) {
...
as String,bannerText: null == bannerText ? _self.bannerText : bannerText // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String heading,  String subheading,  String bannerText,  Color bannerBackgroundColor,  String consentText,  String viewPrivacyPolicyLabel,  String viewPrivacyPolicyUrl,  String? placeholderImage,  List<KidAvatarOptionEntity> avatars)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _KidFormConfigEntity() when $default != null:
return $default(_that.heading,_that.subheading,_that.bannerText,_that.bannerBackgroundColor,_that.consentText,_that.viewPrivacyPolicyLabel,_that.viewPrivacyPolicyUrl,_that.placeholderImage,_that.avatars);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String heading,  String subheading,  String bannerText,  Color bannerBackgroundColor,  String consentText,  String viewPrivacyPolicyLabel,  String viewPrivacyPolicyUrl,  String? placeholderImage,  List<KidAvatarOptionEntity> avatars)  $default,) {final _that = this;
switch (_that) {
case _KidFormConfigEntity():
return $default(_that.heading,_that.subheading,_that.bannerText,_that.bannerBackgroundColor,_that.consentText,_that.viewPrivacyPolicyLabel,_that.viewPrivacyPolicyUrl,_that.placeholderImage,_that.avatars);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String heading,  String subheading,  String bannerText,  Color bannerBackgroundColor,  String consentText,  String viewPrivacyPolicyLabel,  String viewPrivacyPolicyUrl,  String? placeholderImage,  List<KidAvatarOptionEntity> avatars)?  $default,) {final _that = this;
switch (_that) {
case _KidFormConfigEntity() when $default != null:
return $default(_that.heading,_that.subheading,_that.bannerText,_that.bannerBackgroundColor,_that.consentText,_that.viewPrivacyPolicyLabel,_that.viewPrivacyPolicyUrl,_that.placeholderImage,_that.avatars);case _:
  return null;
...
class _KidFormConfigEntity implements KidFormConfigEntity {
  const _KidFormConfigEntity({required this.heading, required this.subheading, required this.bannerText, required this.bannerBackgroundColor, required this.consentText, required this.viewPrivacyPolicyLabel, required this.viewPrivacyPolicyUrl, this.placeholderImage, required final  List<KidAvatarOptionEntity> avatars}): _avatars = avatars;
...
@override
int get hashCode => Object.hash(runtimeType,heading,subheading,bannerText,bannerBackgroundColor,consentText,viewPrivacyPolicyLabel,viewPrivacyPolicyUrl,placeholderImage,const DeepCollectionEquality().hash(_avatars));
...
/// Create a copy of KidFormConfigEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? heading = null,Object? subheading = null,Object? bannerText = null,Object? bannerBackgroundColor = null,Object? consentText = null,Object? viewPrivacyPolicyLabel = null,Object? viewPrivacyPolicyUrl = null,Object? placeholderImage = freezed,Object? avatars = null,}) {
