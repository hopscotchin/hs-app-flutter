...
/// silent background refresh).
 int get refreshTick;/// Non-null when orderNow succeeds — UI should open checkout bottom sheet.
 BuyNowEntity? get checkoutData;/// Non-null when an apply/remove returned a backend-authored sheet — UI
...
@override
int get hashCode => Object.hash(runtimeType,status,cart,errorMessage,pendingItemAction,isCheckoutLoading,isPromoLoading,isMerging,isCartUpdating,const DeepCollectionEquality().hash(staticMessageBars),toastMessage,toastIsError,refreshTick,checkoutData,promoActionSheet);

@override
String toString() {
  return 'CartState(status: $status, cart: $cart, errorMessage: $errorMessage, pendingItemAction: $pendingItemAction, isCheckoutLoading: $isCheckoutLoading, isPromoLoading: $isPromoLoading, isMerging: $isMerging, isCartUpdating: $isCartUpdating, staticMessageBars: $staticMessageBars, toastMessage: $toastMessage, toastIsError: $toastIsError, refreshTick: $refreshTick, checkoutData: $checkoutData, promoActionSheet: $promoActionSheet)';
}
...
/// Create a copy of CartState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? cart = freezed,Object? errorMessage = freezed,Object? pendingItemAction = freezed,Object? isCheckoutLoading = null,Object? isPromoLoading = null,Object? isMerging = null,Object? isCartUpdating = null,Object? staticMessageBars = null,Object? toastMessage = freezed,Object? toastIsError = null,Object? refreshTick = null,Object? checkoutData = freezed,Object? promoActionSheet = freezed,}) {
...
as int,checkoutData: freezed == checkoutData ? _self.checkoutData : checkoutData // ignore: cast_nullable_to_non_nullable
as BuyNowEntity?,promoActionSheet: freezed == promoActionSheet ? _self.promoActionSheet : promoActionSheet // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CartStatus status,  CartEntity? cart,  String? errorMessage,  ({String sku, CartItemAction action})? pendingItemAction,  bool isCheckoutLoading,  bool isPromoLoading,  bool isMerging,  bool isCartUpdating,  List<MessageBarEntity> staticMessageBars,  String? toastMessage,  bool toastIsError,  int refreshTick,  BuyNowEntity? checkoutData,  BackendActionContentEntity? promoActionSheet)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CartState() when $default != null:
return $default(_that.status,_that.cart,_that.errorMessage,_that.pendingItemAction,_that.isCheckoutLoading,_that.isPromoLoading,_that.isMerging,_that.isCartUpdating,_that.staticMessageBars,_that.toastMessage,_that.toastIsError,_that.refreshTick,_that.checkoutData,_that.promoActionSheet);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CartStatus status,  CartEntity? cart,  String? errorMessage,  ({String sku, CartItemAction action})? pendingItemAction,  bool isCheckoutLoading,  bool isPromoLoading,  bool isMerging,  bool isCartUpdating,  List<MessageBarEntity> staticMessageBars,  String? toastMessage,  bool toastIsError,  int refreshTick,  BuyNowEntity? checkoutData,  BackendActionContentEntity? promoActionSheet)  $default,) {final _that = this;
switch (_that) {
case _CartState():
return $default(_that.status,_that.cart,_that.errorMessage,_that.pendingItemAction,_that.isCheckoutLoading,_that.isPromoLoading,_that.isMerging,_that.isCartUpdating,_that.staticMessageBars,_that.toastMessage,_that.toastIsError,_that.refreshTick,_that.checkoutData,_that.promoActionSheet);case _:
  throw StateError('Unexpected subclass');
...
class _CartState implements CartState {
  const _CartState({this.status = CartStatus.initial, this.cart, this.errorMessage, this.pendingItemAction, this.isCheckoutLoading = false, this.isPromoLoading = false, this.isMerging = false, this.isCartUpdating = false, final  List<MessageBarEntity> staticMessageBars = const <MessageBarEntity>[], this.toastMessage, this.toastIsError = false, this.refreshTick = 0, this.checkoutData, this.promoActionSheet}): _staticMessageBars = staticMessageBars;
...
@override final  BuyNowEntity? checkoutData;
...
@override
int get hashCode => Object.hash(runtimeType,status,cart,errorMessage,pendingItemAction,isCheckoutLoading,isPromoLoading,isMerging,isCartUpdating,const DeepCollectionEquality().hash(_staticMessageBars),toastMessage,toastIsError,refreshTick,checkoutData,promoActionSheet);
