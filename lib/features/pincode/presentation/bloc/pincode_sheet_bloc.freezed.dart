...
return apply(_that);case PdpVerifyFailed() when pdpVerifyFailed != null:
return pdpVerifyFailed(_that);case _:
  return orElse();
...
return apply(_that);case PdpVerifyFailed():
return pdpVerifyFailed(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( OpenPincodeSheet value)?  open,TResult? Function( SelectPincodeAddress value)?  selectAddress,TResult? Function( FocusPincodeInput value)?  focusInput,TResult? Function( PincodeInputChanged value)?  pincodeChanged,TResult? Function( ApplyPincode value)?  apply,TResult? Function( PdpVerifyFailed value)?  pdpVerifyFailed,}){
final _that = this;
switch (_that) {
case OpenPincodeSheet() when open != null:
return open(_that);case SelectPincodeAddress() when selectAddress != null:
...
return apply();case PdpVerifyFailed() when pdpVerifyFailed != null:
return pdpVerifyFailed(_that.pincodeError);case _:
  return orElse();
...
return apply();case PdpVerifyFailed():
return pdpVerifyFailed(_that.pincodeError);}
}
...
class PdpVerifyFailed implements PincodeSheetEvent {
  const PdpVerifyFailed(this.pincodeError);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$PdpVerifyFailedCopyWith<PdpVerifyFailed> get copyWith => _$PdpVerifyFailedCopyWithImpl<PdpVerifyFailed>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PdpVerifyFailed&&(identical(other.pincodeError, pincodeError) || other.pincodeError == pincodeError));
}


@override
int get hashCode => Object.hash(runtimeType,pincodeError);

@override
String toString() {
  return 'PincodeSheetEvent.pdpVerifyFailed(pincodeError: $pincodeError)';
}
...
/// @nodoc
abstract mixin class $PdpVerifyFailedCopyWith<$Res> implements $PincodeSheetEventCopyWith<$Res> {
  factory $PdpVerifyFailedCopyWith(PdpVerifyFailed value, $Res Function(PdpVerifyFailed) _then) = _$PdpVerifyFailedCopyWithImpl;
@useResult
$Res call({
 String? pincodeError
});
...
/// @nodoc
class _$PdpVerifyFailedCopyWithImpl<$Res>
    implements $PdpVerifyFailedCopyWith<$Res> {
  _$PdpVerifyFailedCopyWithImpl(this._self, this._then);

  final PdpVerifyFailed _self;
  final $Res Function(PdpVerifyFailed) _then;

/// Create a copy of PincodeSheetEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? pincodeError = freezed,}) {
  return _then(PdpVerifyFailed(
freezed == pincodeError ? _self.pincodeError : pincodeError // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
