...
class _AccountRemoteDataSource implements AccountRemoteDataSource {
  _AccountRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<AccountModel> getAccount({CancelToken? cancelToken}) async {
  ...
  @override
  Future<void> forgetGuestUser({CancelToken? cancelToken}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
