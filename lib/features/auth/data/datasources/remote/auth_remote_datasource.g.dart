...
class _AuthRemoteDatasource implements AuthRemoteDatasource {
  ...
  Future<LoginTicketResponseModel> generateLoginTicket({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<LoginTicketResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/customer/login/generate-ticket',
            queryParameters: queryParameters,
            data: _data,
            cancelToken: cancelToken,
          )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late LoginTicketResponseModel _value;
    try {
      _value = LoginTicketResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
