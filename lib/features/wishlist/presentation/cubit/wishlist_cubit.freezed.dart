...
mixin _$WishlistState {
 ...
 Map<String, String?> get items; Set<String> get inFlight; int get feedbackTick; String? get feedbackMessage;/// Automation key for the feedback snackbar (`WishlistTestStrings`), so a
/// driver can tell add / remove / failure apart without matching copy.
 String? get feedbackKey; bool get feedbackIsError;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WishlistState&&const DeepCollectionEquality().equals(other.items, items)&&const DeepCollectionEquality().equals(other.inFlight, inFlight)&&(identical(other.feedbackTick, feedbackTick) || other.feedbackTick == feedbackTick)&&(identical(other.feedbackMessage, feedbackMessage) || other.feedbackMessage == feedbackMessage)&&(identical(other.feedbackKey, feedbackKey) || other.feedbackKey == feedbackKey)&&(identical(other.feedbackIsError, feedbackIsError) || other.feedbackIsError == feedbackIsError));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(items),const DeepCollectionEquality().hash(inFlight),feedbackTick,feedbackMessage,feedbackKey,feedbackIsError);

@override
String toString() {
  return 'WishlistState(items: $items, inFlight: $inFlight, feedbackTick: $feedbackTick, feedbackMessage: $feedbackMessage, feedbackKey: $feedbackKey, feedbackIsError: $feedbackIsError)';
}
...
@useResult
$Res call({
 Map<String, String?> items, Set<String> inFlight, int feedbackTick, String? feedbackMessage, String? feedbackKey, bool feedbackIsError
});
...
/// Create a copy of WishlistState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? items = null,Object? inFlight = null,Object? feedbackTick = null,Object? feedbackMessage = freezed,Object? feedbackKey = freezed,Object? feedbackIsError = null,}) {
...
as String?,feedbackKey: freezed == feedbackKey ? _self.feedbackKey : feedbackKey // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Map<String, String?> items,  Set<String> inFlight,  int feedbackTick,  String? feedbackMessage,  String? feedbackKey,  bool feedbackIsError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WishlistState() when $default != null:
return $default(_that.items,_that.inFlight,_that.feedbackTick,_that.feedbackMessage,_that.feedbackKey,_that.feedbackIsError);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Map<String, String?> items,  Set<String> inFlight,  int feedbackTick,  String? feedbackMessage,  String? feedbackKey,  bool feedbackIsError)  $default,) {final _that = this;
switch (_that) {
case _WishlistState():
return $default(_that.items,_that.inFlight,_that.feedbackTick,_that.feedbackMessage,_that.feedbackKey,_that.feedbackIsError);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Map<String, String?> items,  Set<String> inFlight,  int feedbackTick,  String? feedbackMessage,  String? feedbackKey,  bool feedbackIsError)?  $default,) {final _that = this;
switch (_that) {
case _WishlistState() when $default != null:
return $default(_that.items,_that.inFlight,_that.feedbackTick,_that.feedbackMessage,_that.feedbackKey,_that.feedbackIsError);case _:
  return null;
...
class _WishlistState implements WishlistState {
  const _WishlistState({final  Map<String, String?> items = const <String, String?>{}, final  Set<String> inFlight = const <String>{}, this.feedbackTick = 0, this.feedbackMessage, this.feedbackKey, this.feedbackIsError = false}): _items = items,_inFlight = inFlight;
...
/// driver can tell add / remove / failure apart without matching copy.
@override final  String? feedbackKey;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_items),const DeepCollectionEquality().hash(_inFlight),feedbackTick,feedbackMessage,feedbackKey,feedbackIsError);
...
/// Create a copy of WishlistState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? items = null,Object? inFlight = null,Object? feedbackTick = null,Object? feedbackMessage = freezed,Object? feedbackKey = freezed,Object? feedbackIsError = null,}) {
